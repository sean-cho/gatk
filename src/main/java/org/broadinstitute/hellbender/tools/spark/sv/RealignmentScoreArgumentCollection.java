...
public final class RealignmentScoreArgumentCollection implements Serializable {
    ...
    public static final double DEFAULT_STRAND_SWITCH_COST = 60;
    ...
    public static final String STRAND_SWITCH_COST_PARAM_FULL_NAME = "realignment-strand-switch-penalty";
    public static final String STRAND_SWITCH_COST_PARAM_SHORT_NAME = STRAND_SWITCH_COST_PARAM_FULL_NAME;
    ...
    public static final String MINIMUM_MAP_QUALITY_PARAM_SHORT_NAME = MISMATCH_COST_PARAM_FULL_NAME;

    @Argument(fullName = STRAND_SWITCH_COST_PARAM_FULL_NAME, shortName = STRAND_SWITCH_COST_PARAM_SHORT_NAME,
              doc = "Phred-scaled cost for a strand switch in a read realigned against and contig or haplotype",
              optional = true)
    public double strandSwitchPenalty = DEFAULT_STRAND_SWITCH_COST;
