...
public final class GATKSVVCFConstants {
    ...
    public static final String INSERT_SIZE_ALLELE_DEPTH = "ISL";
    public static final String DISCORDANT_PAIR_ORIENTATION_ALLELE_DEPTH = "DPAD";

    public static final List<String> GENOTYPING_OPTIONAL_INFO_ANNOTATION_IDS = Collections.unmodifiableList(Arrays.asList(GENOTYPING_PROCESSING_TIME, TEMPLATE_COUNT, HAPLOTYPE_COUNT));
